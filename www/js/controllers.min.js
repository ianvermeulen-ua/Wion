...
.controller('AboutCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", "$ionicScrollDelegate", "ContactInfo", "MobilePage", function($scope, $timeout, $rootScope, $sce, $localstorage, $ionicScrollDelegate, ContactInfo, MobilePage) {
...
angular.module('roots.controllers')
  ...
  .controller('CalendarCtrl', ["$scope", "$ionicSideMenuDelegate", "$timeout", "$rootScope", "$sce", "$localstorage", "$ionicModal", "$ionicPopup", "$ionicLoading", "$location", "uiCalendarConfig", "Calendar", function ($scope, $ionicSideMenuDelegate, $timeout, $rootScope, $sce, $localstorage, $ionicModal, $ionicPopup, $ionicLoading, $location, uiCalendarConfig, Calendar) {
    $scope.uiConfig = {
      calendar: {
        height: 750,
...
.controller('HomeCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", "$ionicPopup", "Post", "Bookmark", "Calendar", function($scope, $timeout, $rootScope, $sce, $localstorage, $ionicPopup, Post, Bookmark, Calendar) {
...
.controller('MemberCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", "$compile", "$ionicPopup", "$ionicLoading", "User", function($scope, $timeout, $rootScope, $sce, $localstorage, $compile, $ionicPopup, $ionicLoading, User) {
...
.controller('WeducCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", function($scope, $timeout, $rootScope, $sce, $localstorage) {
