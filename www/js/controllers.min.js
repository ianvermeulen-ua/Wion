		...
		if(form.$valid) {			
			...
			User.getRegisterNonce().success(function(response){
				...
				if(response.status==='ok'){
          			...
          			User.register(nonce, $scope.signupData.firstName, $scope.signupData.lastName, $scope.signupData.username, $scope.signupData.email, $scope.signupData.password ).success(function(response){
