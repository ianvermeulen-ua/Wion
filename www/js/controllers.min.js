...
.controller('AboutCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", "$ionicScrollDelegate", "ContactInfo", function($scope, $timeout, $rootScope, $sce, $localstorage, $ionicScrollDelegate, ContactInfo) {
    $scope.contactInfos = [];
