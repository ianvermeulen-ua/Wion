...
.controller('CalendarCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", "$ionicModal", "$ionicPopup", "$ionicLoading", "$location", function($scope, $timeout, $rootScope, $sce, $localstorage, $ionicModal, $ionicPopup, $ionicLoading, $location) {
