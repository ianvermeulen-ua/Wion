...
.controller('CalendarCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", "$ionicModal", "$ionicPopup", "$ionicLoading", "$location", "Calendar", function($scope, $timeout, $rootScope, $sce, $localstorage, $ionicModal, $ionicPopup, $ionicLoading, $location, Calendar) {
     $scope.uiConfig = {
      calendar:{
        height: 750,
