...
.run(["$ionicPlatform", "$rootScope", "$state", "User", "Walkthrough", "$cordovaNetwork", "$ionicLoading", "$ionicPopup", function($ionicPlatform, $rootScope, $state, User, Walkthrough, $cordovaNetwork, $ionicLoading, $ionicPopup) {
