...
.controller('CategoryMenuArchiveCtrl', function($scope, $ionicModal, $timeout, $rootScope, $sce, $localstorage, $ionicPopup, category, PostTax, Bookmark) {
	...
	$scope.localStoragePrefix = 'category_menu_' + $scope.category.id + '_'; 
	...
	$scope.getPosts = function(){
		...
		PostTax.get($scope.settings.current_page, 'menu', 'menu_cat', $scope.category.slug, $scope.items_per_page).success(function(response){
